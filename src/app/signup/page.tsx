                ...
                <Card className="bg-white/5 backdrop-blur-xl border-white/10 shadow-2xl">
                    ...
                    <CardContent className="space-y-5 pt-4">
                        ...
                        <Button
                            ...
                            className="w-full h-12 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-medium text-base rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-indigo-500/25 disabled:opacity-50"
                        >
                            {loading ? (
